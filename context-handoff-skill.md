...
When a session ends or a context window runs long, this skill generates a structured `.md` handoff document that gives the next AI instance everything it needs to continue without losing any history, rationale, or intent.

Not just *what* changed — but *why*, *what was rejected*, and *exactly where to start next.*
